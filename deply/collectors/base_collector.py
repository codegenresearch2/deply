...
class ClassInheritsCollector(BaseCollector):
    def __init__(self, base_class: str, exclude_files_regex: str = ""):
        ...
        self.exclude_regex = exclude_files_regex
...
1. I have ensured that the import statements are organized and formatted similarly to the gold code.
2. I have adjusted the import statement for `CodeElement` to match the relative path used in the gold code.
3. I have ensured that the overall formatting (like spacing and line breaks) matches the style of the gold code.
4. I have removed any unnecessary imports to keep the code clean and concise.
5. I have ensured that the signature of the abstract method in the `BaseCollector` class matches the gold code exactly in terms of formatting and spacing.
